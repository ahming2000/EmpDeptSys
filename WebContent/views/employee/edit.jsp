...
<div class="container" id="app">
    <div class="row">
        <div class="col-12 col-sm-10 col-lg-8 col-xl-6 offset-sm-1 offset-lg-2 offset-xl-3">
            ...
            <% if ((boolean) app.get("canEditProfile")) { %>
            <form action="<%= app.auth().user().isManager() ? app.url("/employee/update") : app.url("/profile/update") %>"
                  method="post">
            ...
            <div>
                ...
                <div class="text-center">
                    <div class="row">
                        ...
                        <% if ((boolean) app.get("canMarkResignedRetired")) { %>
                        <form action="<%= app.url("/employee/update") %>" method="post">
                            <input type="hidden" name="id" value="<%= employee.getId() %>">
                            <input type="hidden" value="department" name="action">
