...
@NamedQueries({
        @NamedQuery(name = "DepartmentManager.all", query = "SELECT dm FROM DepartmentManager dm"),
        @NamedQuery(name = "DepartmentManager.find.empId.deptId", query = "SELECT dm FROM DepartmentManager dm WHERE dm.id.employeeId = :employee_id AND dm.id.departmentId = :department_id"),
})
